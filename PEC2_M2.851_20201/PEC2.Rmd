...
Reemplazamos los valores NA de la edad por la media recortada (obviando un 5% de los valores de cada cola para ignorar valores muy alejados de la media)

```{r}
df<-data
df$Age[is.na(df$Age)]<-mean(data$Age,na.rm=TRUE, trim=0,05)

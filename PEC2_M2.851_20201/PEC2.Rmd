...
```{r}
modelo.logit <- glm(data = data, formula = Survived ~ Sex + Age + Pclass + Embarked, family = "binomial")
...
corrplot.mixed(corr = cor(data[,c("SibSp", "Parch", "Sex", "Fare", "Pclass", "Embarked", "Survived")],
                          method = "pearson"))
```
